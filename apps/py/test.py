...
# # http://balancer-domain/?test=test
# docker run --network host --rm jordi/ab -k -c 100 -n 10000 http://0.0.0.0:3200/?test=test
# curl http://localhost:3200/api/get_settings
# curl -I http://localhost:3200/?test=test


url='http://0.0.0.0:3200/?test=test'
